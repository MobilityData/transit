...
| `instructions`| Text | Optional | The `instructions` field indicates instructions for the pathway taken from the `from_stop_id` to the `to_stop_id` (E.g. "Go downstairs to the station concourse"). |
